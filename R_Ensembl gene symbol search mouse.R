...
colnames(Search_results_4) <- c("Anchored_input_gene", "Input_gene_symbols", "Anchored_output_gene", "Ensembl_official_symbols", "Ambiguous_Unique",  "Gene_description", "Ensembl_ID", "NCBI_ID", "MGI_ID", "Gene_type") # setting column names
head(Search_results_4, n=20) # showing first n rows
